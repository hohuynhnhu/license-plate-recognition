...
def detect_license_plate():
    ...
    while True:
        ...
        if best_conf > 0.6 and best_plate is not None and (current_time - last_ocr_time >= 15):
            ...
            cv2.imwrite("bien_so_xe_vao.jpg", best_frame)
            cv2.imwrite("plate_gray.jpg",plate_gray)
            cv2.imwrite("plate_blur.jpg",plate_blur)
            ...
            url_image_vao = upload_image_to_cloudinary("bien_so_xe_vao.jpg")
            if os.path.exists("bien_so_xe_vao.jpg"):
                os.remove("bien_so_xe_vao.jpg")
